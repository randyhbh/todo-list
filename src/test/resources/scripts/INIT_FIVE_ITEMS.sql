...
VALUES (1, 'NOT_DONE', 'test 1 description', now(), now() + 1, null);
INSERT INTO item (id, status, description, created_at, due_at, done_at)
VALUES (2, 'NOT_DONE', 'test 2 description', now(), now() + 2, null);
INSERT INTO item (id, status, description, created_at, due_at, done_at)
VALUES (3, 'NOT_DONE', 'test 3 description', now(), now() + 3, null);
INSERT INTO item (id, status, description, created_at, due_at, done_at)
